 ...
 * returns String
 **/
module.exports.deleteNo2_co = function(req, res, next) {
    //Parameters
    console.log(req);
    res.send({
 ...
 * returns String
 **/
module.exports.getNo2_co = function(req, res, next) {
    //Parameters
    console.log(req);
    res.send({
 ...
 * returns String
 **/
module.exports.postNo2_co = function(req, res, next) {
    //Parameters
    console.log(req);
    res.send({
 ...
 * returns String
 **/
module.exports.putNo2_co = function(req, res, next) {
    //Parameters
    console.log(req);
    res.send({
